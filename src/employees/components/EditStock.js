                    ...
                    <table className="min-w-full text-sm">
                        <thead className="bg-gray-50 text-gray-600 uppercase text-xs">
                            <tr>
                                ...
                                <th className="px-4 py-3 text-left hidden sm:table-cell">วันที่ปรับสต็อก</th>
                                <th className="px-4 py-3 text-left">สินค้า</th>
                                <th className="px-4 py-3 text-left">จำนวนที่ปรับ</th>
                                <th className="px-4 py-3 text-left hidden sm:table-cell">ผู้ปรับสต็อก</th>
                        ...
                        <tbody>
                            {products.map((item) => (
                                <tr key={item.id} className="border-t">
                                    ...
                                    <td className="px-4 py-2 hidden sm:table-cell">{item.stockAdjustmentAt}</td>
                                    <td className="px-4 py-2">{item.product}</td>
                                    <td
                                        className={`px-4 py-2 font-semibold ${item.adjustmentType === "เพิ่มสินค้า"
                                                ? "text-green-600"
                                    ...
                                    <td className="px-4 py-2 hidden sm:table-cell">{item.stockAdjuster}</td>
